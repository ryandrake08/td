...
@interface TBActionClockView : NSView
...
@property (strong, nonatomic) NSColor* faceBackgroundColor;
...
@property (strong, nonatomic) NSFont* digitFont;

/// The color of the digits appearing inside the clock
@property (strong, nonatomic) NSColor* digitColor;
...
@property (strong, nonatomic) NSColor* handColor;
...
- (NSColor*)analogClock:(TBActionClockView*)clock graduationColorForIndex:(NSInteger)index;
