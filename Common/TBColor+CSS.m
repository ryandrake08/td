...
// Static lookup of css color names
static NSDictionary* cssColorNames = nil;
static NSDictionary* cssHexCodes = nil;
...
+ (TBColor*)colorWithRGBHex:(UInt32)hex {
    ...
    return [TBColor colorWithRed:r / 255.0f
                           green:g / 255.0f
                            blue:b / 255.0f
                           alpha:1.0f];
}

// Returns a color by scanning the string for a hex number and passing that to +[XXColor colorWithRGBHex:]
// Skips any leading whitespace and ignores any trailing characters
+ (TBColor*)colorWithHexString:(NSString*)stringToConvert {
    NSScanner* scanner = [NSScanner scannerWithString:stringToConvert];
    [scanner setCharactersToBeSkipped:[NSCharacterSet punctuationCharacterSet]];
    unsigned hexNum;
    if(![scanner scanHexInt:&hexNum]) return nil;
    return [TBColor colorWithRGBHex:hexNum];
}
...
- (UInt32)rgbHex {
    ...
    return (UInt32)(r * 255.0f) << 16 | (UInt32)(g * 255.0f) << 8 | (UInt32)(b * 255.0f);
}
