...
namespace TBWin
{
    ...
    public class TournamentConfigSerializer : JavaScriptSerializer
    {
        public TournamentConfigSerializer() : base()
        {
            RegisterConverters(new JavaScriptConverter[] { new DateTimeJavaScriptConverter() });
        }
    }
}
